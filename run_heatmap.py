...
for met_inc in met_incs:
    ...
    for rs_inc in rs_incs:
        ...
        print(f"mono tol {time.perf_counter() - begin}")  #
        begin = time.perf_counter()  #

        run_calc_tol(file_co, 1000, 0.01, 0.1, rs_inc)
        print(f"co tol {time.perf_counter() - begin}")  #
        ...
        begin = time.perf_counter()  #
        mdkratio = run_evoratio(tol_file_mono, tol_file_co, "tol_time")
        print(f"mdkratio {time.perf_counter() - begin}")  #
        ...
        print(f"mono frac {time.perf_counter() - begin}")  #
        begin = time.perf_counter()  #

        run_calc_frac(file_co, 1000, 5, rs_inc)
        print(f"co frac {time.perf_counter() - begin}")  #
        ...
        begin = time.perf_counter()  #
        fracratio = run_evoratio(frac_file_mono, frac_file_co, "frac")
        print(f"fracratio {time.perf_counter() - begin}")  #
