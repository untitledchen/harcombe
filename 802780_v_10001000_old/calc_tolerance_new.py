...
def run(filename, init_pop, perc_cutoff, interval):
    ...
    #seed = data['seed'][0]
    seed = filename.split('_')[1][:3]
    #culture = data['culture'][0]
    culture = filename.split('_')[0]
...
run("co_seed269_rep10_mu(0.001, 0.001)_cycles10_init_R(1, 2780, 0)_init_n(5, 5)_init_lag(1, 1)_Ta5_alpha(3, 3)_null(1.1, 1.1)_postmut.csv", 1000, 0.01, 0.25)
run("mono_seed716_rep10_mu(0.001, 0.001)_cycles10_init_R(80, 2780, 0)_init_n(5, 5)_init_lag(1, 1)_Ta5_alpha(3, 3)_null(1.1, 1.1)_postmut.csv", 1000, 0.01, 0.25)
